    ...
    <div id="wrapper">
       ...
       <!-- Navigation -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
							...
							<li class="active">
                                <i class="fa fa-file-text"></i> New Role
                            </li>
		...
		<div class="row">
			...
			<form action = "savescripts/save_role.php" method="POST" name="frm_role" id="frm_role" >
				<!-- on validateRegistration line to be used to validate user registration details -->
				<table id="tbl_role" class='table table-condensed table-small-font'>
					<tr>
					<td>
						<div class="row">
							<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2"><strong>Role Name</strong></div>
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
								<input class="form-control" type="text" name="rname"  size=30 required />
							</div>
						</div>
					</td>
					</tr>
					...
					<td >
						<div class="row">
							...
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
								<input class="form-control" type="text" name="rdesc"  size=20 required />
							</div>
						</div>
					</td>
					</tr>
					<tr>
					<td id="sb_btn"><input class="btn btn-info" type="submit"  value="Add role" id="facsub_btn" />
				...
				<div class='modal-dialog'>
					<div class='modal-content'>
						...
						<div class='modal-footer'>
							<a href='role_create.php'><button type='button' class='btn btn-default'>Close</button></a>
						</div>
					</div>
