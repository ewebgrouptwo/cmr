...
<title>Add New Role Permissions</title>
...
<div id="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
							...
							<li class="active">
                                <i class="fa fa-file-text"></i> Assign Role Permission
                            </li>
	...
	<div id="page-wrapper">
		...
		<div class="row">
			...
			<form action = "savescripts/save_rpermission.php" method="POST"  name="frm_rpermission" id="frm_rpermission" >
				...
				<table id="tbl_rpermission" class='table table-condensed table-small-font'>
					...
					<td>
						<div class="row">
							...
							<input type='hidden' name='ptype' value='assign_perm' id='ptype' />
							</div>
						</div>
					</td>
					</tr>
				...
				<div class='modal-dialog'>
					<div class='modal-content'>
						...
						<div class='modal-footer'>
							<a href='assign_permission.php'><button type='button' class='btn btn-default'>Close</button></a>
						</div>
					</div>
