       ...
       <!-- Navigation -->
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
				...
				<?php
					if(($_GET['type'])=="complete_cmr_num" |($_GET['type'])=="complete_cmr_per" |($_GET['type'])=="response_cmr_per" |($_GET['type'])=="sum_cmr" |($_GET['type'])=="percent_cmr"){
						$report_type=($_GET['type']);
						$statistical_report = new report;
						echo $statistical_report->view_statistics_details($report_type);
					} elseif (($_GET['type'])=="pass_rate"){
						$report_type=($_GET['type']);
						$statistical_report = new report;
						echo $statistical_report->view_student_pass_rate();
						
					} else {
						echo "<div class='alert alert-success'>
								<strong>Report type not specified.</strong>
							</div>";
					}
				?>
